...
<html lang="en">
    <head>
        ...
        <link rel = "icon" href = "slider-img/soup.png" type = "image/x-icon">
    </head>
    <body>
        ...
        <header class="l-header" id="header">
            <nav class="nav bd-container">
                <a href="#" class="nav__logo">Halal Food</a>
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#cart" class="nav__link">Add Cart</a></li>
        ...
        <main class="l-main">
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    ...
                    <img src="slider-img/cook.png" alt="" class="about__img">
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="menu-img/pic1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Barbecue salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$22.00</span><br>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                        <a href="#cart" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="menu-img/pic2.png" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic3.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span><br><br>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                        <a href="#cart" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic4.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic5.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic6.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span><br><br>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic7.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic8.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic9.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span><br><br>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic10.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic11.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span><br><br>
                        <a href=""  class="button buy__button" title="">Buy now</a>
                    ...
                    <div class="menu__content">
                        <img src="menu-img/pic12.png" alt="" class="menu__img">
                        <h3 class="menu__name">Spinach salad</h3>
                        <span class="menu__detail">Delicious dish</span>
                        <span class="menu__preci">$9.50</span>
                        <br>
            ...
            <section class="cart section bd-container" id="cart">
                <div class="contact__container bd-grid">
                    <div class="cart__data">
                        <span class="section-subtitle contact__initial">Add Cart</span>
                        <h2 class="section-title contact__initial">Cart Item's</h2>
                    </div>
                </div>
            </section>
        </main>
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                <div class="footer__content">
                    <a href="#" class="footer__logo">Halal Food</a>
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li>khulna</li>
                        <li>999 - 888 - 777</li>
                        <li>Halalfood@email.com</li>
                    </ul>
                </div>
            </div>

            <p class="footer__copy">&#169; 2022 Codecary. All right reserved</p>
        </footer>
